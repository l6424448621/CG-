<%@page import="com.tong.cms.metas.Gender"%>
					...
					<div class="card">
					  ...
					  <div class="card-body">
					    ...
					    <form:form modelAttribute="userForm" action="/reg" class="form-inline" method="post">
					    	...
					    	<p>　用户名：<form:input path="username" placeholder="请填写用户名" class="form-control"/></p>
					    	<p>密　　码：<form:password path="password" placeholder="请填写密码" class="form-control"/></p>
					    	<p>确认密码：<form:password path="rePassword" placeholder="重复密码" class="form-control"/></p>
					    	<p>性　　别：
							<form:radiobuttons path="gender" items="<%=Gender.values()%>" itemLabel="description" delimiter="&nbsp;&nbsp;"/>
					    	<p class="w-100">　　　　　
							<button type="submit" class="btn btn-info">开始注册</button></p>
